...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.ApiRequestLog())
	{
	...
	geminiRouter.Use(middleware.ApiRequestLog())
	{
	...
	geminiCompatibleRouter.Use(middleware.ApiRequestLog())
	{
	...
	relayV1Router.Use(middleware.ApiRequestLog())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.ApiRequestLog(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.ApiRequestLog())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.ApiRequestLog(), middleware.Distribute())
	{
